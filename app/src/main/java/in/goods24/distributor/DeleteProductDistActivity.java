...
public class DeleteProductDistActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_delete_product_dist);
        ...
        fetchProductDetails();
        findViewById(R.id.deleteProdBtn).setOnClickListener(this);
    }

    public void onClick(View view){
        switch(view.getId()){
            case R.id.deleteProdBtn:
                onDelete();
                break;
        }
    }
    ...
    private void onDelete() {
        ...
        Log.d("REQ","Request parameters for delete API are >>>"+rp+">>"+phpName);
        makeDeleteProductRestCall(rp,phpName);
    }

    private void makeDeleteProductRestCall(RequestParams rp, String phpName) {
    ...
    private void afterDeletion(String respMsg, int errCode) {
        if(0==errCode){
    ...
    private class ViewProductHelper extends AsyncTask<String,String,String> {
        ...
        protected void onPreExecute() {
            Log.d("REQ","preExecuteTask"+rp+">>>"+phpName);
        }
        ...
        private void performingSuccessOperation(String respMsg, int errCode,JSONObject res) {
            if(errCode==0){
                try {
                    ...
                    Bitmap bitmap = BitmapFactory.decodeStream(new ViewProductDistActivity.FlushedInputStream(isImage));
