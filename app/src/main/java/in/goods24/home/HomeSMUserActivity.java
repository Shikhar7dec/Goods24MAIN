...
public class HomeSMUserActivity extends AppCompatActivity {
    private int backButtonCount= 0;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_home_sm_user);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.sm_user_home_menu, menu);
        return true;
    }
    @Override
